    ...
    <div class="form-container">
        ...
        <div class="content form-section">
            ...
            <div>
                ...
                <input type="number" id="ssn" name="ssn" value="<?= isset($contractor) ? htmlspecialchars($contractor['ssn'] ?? '') : '' ?>">
            </div>
            <div>
        ...
        <div class="content form-section">
            ...
            <div>
                ...
                <select id="on_call_status" name="on_call_status">
                    ...
                    <option value="0" <?= isset($contractor) && $contractor['on_call_status'] == 0 ? 'selected' : '' ?>>NOT Available (NOT On Call)</option>
                </select>
            </div>
            <div>
