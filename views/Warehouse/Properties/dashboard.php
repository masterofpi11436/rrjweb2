        ...
        <tbody>
            <?php foreach ($pendings as $pending): ?>
                <tr>
                    ...
                    <td><a href="/warehouse/properties/cancel/<?= htmlspecialchars($pending['id']) ?>">Cancel Order</a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
        ...
        <tbody>
            <?php foreach ($orders as $order): ?>
                <tr>
                    ...
                    <td>
                        <a href="/warehouse/properties/request/one/<?= htmlspecialchars($order['id']); ?>">View</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
