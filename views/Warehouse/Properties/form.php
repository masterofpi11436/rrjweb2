<form action="/warehouse/properties/section">
    <button>Home</button>
</form>

<div class="container">
    <form method="get" action="/warehouse/properties/items" id="searchForm">
...
<div id="cartItems">
    ...
    <form class="checkout-btn" action="/warehouse/properties/verify" id="checkoutForm">
    ...
    <?php foreach ($items as $item): ?>
        <div class="item-card">
            ...
            <div class="item-details">
                ...
                <form action="/warehouse/properties/items" method="post" class="cartForm">
