...
<p><strong>Approved By:</strong> <?= htmlspecialchars($order['warehouse_first_name'] . ' ' . $order['warehouse_last_name']) ?></p>
<p><strong>Date Approved:</strong> <?= htmlspecialchars($order['approved_denied_at']) ?></p>
