...
class Properties extends Controller
{
    ...
    public function dashboard(): Response
    {
        ...
        $this->response->appendBody($this->viewer->render("shared/warehouse_header.php", ["title" => "Property Dashboard",
                                                                                "heading" => "Property Dashboard"]));

        // Render the all items view
        $this->response->appendBody($this->viewer->render("Warehouse/Properties/dashboard.php", ["orders" => $orders, "pendings" => $pendings]));
    ...
    public function cancel(string $id) 
    {
        ...
        if ($success) {
            return $this->redirect("/warehouse/properties/cancelrequest");
        } else {
    ...
    public function items(): Response
    {
        ...
        // Render the all items view
        $this->response->appendBody($this->viewer->render("Warehouse/Properties/form.php", ["items" => $items,
                                                                                            "itemTypes" => $itemTypes,
    ...
    public function verify(): Response
    {
        ...
        $this->response->appendBody($this->viewer->render("Warehouse/Properties/verify.php", ['section' => $section, 'items' => $items]));
    ...
    public function update(): Response
    {
        ...
        header('Location: /warehouse/properties/verify');
        exit;
    }
    ...
    public function submit(): Response
    {
        ...
        try {
            ...
            return $this->redirect('/warehouse/properties/success');
    ...
    public function success(): Response
    {
        ...
        // Render the all items view
        $this->response->appendBody($this->viewer->render("Warehouse/Properties/success.php"));
...
/***** Manage Requests ***************************************************************************************/
    ...
    public function viewOrder(string $id): Response
    {
       ...
       // Render the warehouse_header
        ...
        $this->response->appendBody($this->viewer->render("Warehouse/Properties/approve_deny.php", ["order" => $order]));
